...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', 'Unspecified' for activities without difficulty, or empty for all)
    """
    ...
    if difficulty and difficulty != "Unspecified":
        query["difficulty"] = difficulty
    elif difficulty == "Unspecified":
        # "Unspecified" means only activities WITHOUT a difficulty level
